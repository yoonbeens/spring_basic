...
import com.spring.mywebspring.command.ReplyVO;
import com.spring.mywebspring.reply.service.IReplyService;
...
public class ReplyController {
	...
	public Map<String, Object> getList(@PathVariable int bno, @PathVariable int pageNum) {
		...
		/*
		 ...
		 복수개의 값을 리턴하기 위해서 리턴 타입을 Map으로 줄지, VO형식으로 줄지를 결정합니다.
		 댓글 목록 리스트와 전체 댓글 개수를 Map으로 함께 전달할 예정
		 */
		...
		map.put("total", total); //게시글에 달려 있는 댓글의 총 개수
