...
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-9 write-wrap">
                        ...
                        <div id="replyList">
                            ...
                            <!-- 자바스크립트단에서 반복문을 이용해 댓글의 개수만큼 반복 표현.
    ...
    <script>
        ...
        window.onload = function() {
            ...
            //게시글 상세보기 화면에 처음 진입했을 시 댓글 리스트를 한번 불러보자
            getList(1, true); 
            ...
            function getList(pageNum, reset) {
                ...
                fetch('${pageContext.request.contextPath}/reply/getList/' + bno + '/' + pageNum)
                    ...
                    .then(data => {
                        ...
                        //페이지번호 * 이번 요청으로 받은 댓글 수보다
                        //전체 댓글 개수가 작다면 더보기 버튼은 없어도 된다.
            ...
            그러다보니 이벤트가 등록되는 것보다 비동기 함수(fetch)의 실행이 
            먼저 끝날 것이라는 보장이 없기 때문에
            해당 방식은 이벤트 등록이 불가능합니다.
            
            이 때는, 이미 실제로 존재하는 #replyList에 등록하고,
            이벤트를 자식에게 위임하여 사용하는 addEventListener를 통해 처리를 해야 합니다.
            */
            ...
            document.getElementById('replyList').addEventListener('click', e => {
               ...
               if(e.target.classList.contains('replyModify')) {
                    ...
                    //부트스트랩 쓸 거면 이렇게는 안되고 제이쿼리 써야 한다.
                    // document.getElementById('replyModal').classList.remove(fade);
            ...
            function parseTime(regDateTime) {
                ...
                //원하는 날짜로 객체를 생성(month는 0부터 세기 때문에 -1해줘야 한다)
