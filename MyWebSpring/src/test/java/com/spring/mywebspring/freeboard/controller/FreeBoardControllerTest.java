package com.spring.mywebspring.freeboard.controller;
...
import com.spring.mywebspring.controller.FreeBoardController;
...
//	private FreeBoardController controller;
	...
	public void setup() {
		...
		//테스트할 컨트롤러 수동 주입. 하나의 컨트롤러 자체만 테스트를 진행할 대 이렇게 씁니다.
//		this.mockMvc = MockMvcBuilders.standaloneSetup(controller).build();
	...
	void testContent() throws Exception {
		ModelAndView mv =
		mockMvc.perform(MockMvcRequestBuilders.get("/freeboard/content").param("bno", "3"))
	...
	public void testModify() throws Exception {
		...
		String viewPage = mockMvc.perform(
				MockMvcRequestBuilders.post("/freeboard/update")
